...
export default function News() {
  ...
  return (
    <div className='text-gray-700 space-y-3 bg-gray-200 rounded-xl pt-2 w-full max-w-6xl mx-auto'>
        ...
        <div key={article.url}>
          <a href={article.url} target='_blank'>
            <div className='flex items-center justify-between px-4 py-2 space-x-1 hover:bg-gray-300 transition duration-300'>
              ...
              <img src={article.urlToImage} width={100} className='rounded-xl' />
            </div>
          </a>
        </div>
      ))}
      <button
        className='text-sm font-mono text-blue-500 px-4'
